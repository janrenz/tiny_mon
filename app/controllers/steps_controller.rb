...
protected
  def step_params type
    params.require(type.underscore.to_sym).permit(:user_agent, :send_key, :code, :id, :url, :duration, :content, :count, :dateformat, :field, :value, :negate, :name, :scope, :check_http_code, :mincount, :maxcount, :set_value_direct)
  end
